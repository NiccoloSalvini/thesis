...
```{r FIRENZE, echo=FALSE, imgcenter = TRUE, fig.cap = "Spatial Data Analysis", fig.retina=1}
knitr::include_graphics("images/spatial.png") 
```

```{r FIRENZE, echo=FALSE, imgcenter = TRUE, fig.cap = "Spatial Data Analysis Rayshader", fig.retina=1}
