...
CSS is a style sheet language used for modifying the appearance of a document written in a _markup_ language[@css_2020]. The combination of HTML and CSS offers a wide flexibility in building web sites, mirrored by the vast amount of different design options that can be made. Each further language or tecnology added, also increases the layers of diffuclty into scraping.
