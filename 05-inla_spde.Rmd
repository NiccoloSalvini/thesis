...
- Beyesian comoutatiion choice INLA 
- SPDE 
- R INLA package 
- example 
...
## Latent Gaussian Models{#latentGaussian}
...
$f=\left\{f_{1}(\cdot), \ldots, f_{L}(\cdot)\right\}$ is a collection of fmunctions defined in terms of a set of covariates $z = (z_1, … , z_L)$. The terms $f_l(⋅)$ can assume different forms such as smooth and
