...
Durante una conversazione con alcuni amici^[footnote a caso]
...
Mentre in America è sufficiente richiamare un API con latitudine e longitudine della quadrettatura di terra necessaria per ottenere i [dati](https://it.wikipedia.org/wiki/Dato) di elevazione (.tif), in Italia l'unica soluzione è pagare google che tramite le sue private API è in grado di venderceli dietro autenticazione.
