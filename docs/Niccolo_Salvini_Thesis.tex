...
These are few examples of how websites can be built and infinitely many others are available ranging from the easiest to the most complex, as in figure @ref(fig:html\_tree).
...
\chapter{API Technologies Stack}\label{Infrastructure}}
