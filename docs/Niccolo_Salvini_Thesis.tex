...
\caption{\label{fig:semivariogram}Semivariogram on a linear model Pearson residuals}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{07-model_fitting_files/figure-latex/summhyper-1.pdf}
...
\begin{figure}
\centering
\includegraphics{07-model_fitting_files/figure-latex/predgrid-1.pdf}
