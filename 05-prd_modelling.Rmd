...
```{definition,GP,name="GP definition", echo = T}
...
```{r matern, fig.cap="Matérn covariance function for 4 different phi values and fixed nu = .5, dashed red horizontal line when covariance is .1"}
ggplot(NULL)+
  stat_function(fun = matern, args = list(kappa= 0.5, phi = 1),aes(colour  = "phi = 1"), size = 1.2, alpha = .6)+
  stat_function(fun = matern, args = list(kappa= 0.5, phi = 1/2),aes(colour = "phi = 1/2"),size = 1.2, alpha = .6)+
  stat_function(fun = matern, args = list(kappa= 0.5, phi = 3/2),aes(colour = "phi = 3/2"),size = 1.2, alpha = .6)+
  stat_function(fun = matern, args = list(kappa= 0.5, phi = 80),aes(colour = "phi = 80"),size = 1.2, alpha = .6)+
  xlim(0,12)+
  ...
  scale_colour_brewer(TeX("$Values \\, of \\, \\phi$")) +
