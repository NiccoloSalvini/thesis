...
x = seq(1,50)
ggplot(tibble(x = x))+
  stat_function(fun = matern, args = list(phi= 0.25, kappa = 1), colour = "green", size = 1.2)+
  stat_function(fun = matern, args = list(phi= 0.25, kappa = 1/2), colour = "red",size = 1.2)+
  stat_function(fun = matern, args = list(phi= 0.25, kappa = 3/2),colour = "blue",size = 1.2)+
  stat_function(fun = matern, args = list(phi= 0.25, kappa = 80),colour = "purple",size = 1.2)+
  labs(
...
```{r pitcpo, fig.cap="Left: histogram of cross-validate PIT, Right: qq plot for Unif(0,1)"}
...
qq = ggplot(data = NULL, aes(sample = model$cpo$pit)) +  
  ...
  stat_qq_line(distribution = qunif, colour = "green",alpha=.3, size = 1) +
