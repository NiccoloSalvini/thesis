...
```{definition, gmrf, name ="GMRF"}
A latent gaussian random field e.g. $\boldsymbol\eta$ is said a GMRF if it has a multivariate normal density with additional conditional independence (also called the “Markov property”) [@wang2018bayesian].
```
