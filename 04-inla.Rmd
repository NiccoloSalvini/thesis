...
```{r table_INLA}
knitr::kable(m0$summary.fixed, booktabs = T, caption = "Output summary statistics for the model m0")
```
...
knitr::kable(
  hpdm, 
  booktabs = TRUE,
  caption = "Higer Posterior Density Interval with .1 Confidence Level probability"
)
```
