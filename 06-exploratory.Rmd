...
library(drake, quietly = F)
library(readr, quietly = F)
library(kableExtra, quietly = F)
library(tidyverse, quietly = F)
library(broom, quietly = F)
library(future, quietly = F)
library(viridis, quietly = F)
library(leaflet, quietly = F)
library(sp, quietly = F)
library(sf, quietly = F)
library(glue, quietly = F)
library(ggpmisc, quietly = F)
library(gstat, quietly = F)
library(stringi, quietly = F)
library(scales, quietly = F)
library(plotly, quietly = F)
library(INLA, quietly = F)
## review text, mining
library(tidytext, quietly = F)
library(stopwords, quietly = F)
library(widyr, quietly = F)
library(igraph, quietly = F)
library(ggraph, quietly = F)
## missing, profile
library(caret, quietly = F)
library(tidyverse, quietly = F)
library(naniar, quietly = F)
library(forcats, quietly = F)
library(visdat, quietly = F)
library(ComplexHeatmap, quietly = F)
library(patchwork, quietly = F)
library(ggridges, quietly = F)
library(latex2exp, quietly = F)
## html widget 
library(reactable, quietly = F)
library(crosstalk, quietly = F)
...
## aggiungi tasks, anche quelle di text mining
## suddividi di più il worflow
## 
...
```{r data_prep, message=FALSE, eval=FALSE}
...
dati_sp <- SharedData$new(dati2, group = "houses")
...
```{r map_visual, eval=FALSE, echo=FALSE}
